...
public class Participant {
    ...
    public Participant(final String id, final String name, final String farmName, final String email, final String telephone,
                       final String address, final String zipCode, final String city, final String country) {
        this(id, name, farmName, email, telephone, address, zipCode, city, country, new LinkedHashSet<Animal>());
    }

    @JsonCreator
    public Participant(@JsonProperty("id") final String id, @JsonProperty("name") final String name, @JsonProperty("farmName") final String farmName,
