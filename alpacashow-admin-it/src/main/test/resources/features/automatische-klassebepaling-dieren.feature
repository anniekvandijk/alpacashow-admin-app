...
Functionaliteit: Als er via online inschrijving of inlezen van een lijst dieren worden aangemeld,
  ...
  Nakomelingenklassen kennen klassebepaling (en dus ook geen leeftijdsklasse).
  ...
  Scenario: Wijzigen dier haltershow
    Stel ik wil mijn inschrijving wijzigen voor de haltershow van 01-04-2016
    Als  ik via een scherm een dier wijzig met de volgende gegevens
      | label           | waarde      | wijziging   |
      | soort           | huacaya     | suri        |
      | geslacht        | man         |             |
      | kleur           | wit         |             |
      | geboortedatum   | 15-05-2014  |             |
      | scheerdatum     | 01-05-2015  |             |
    Dan verwacht ik dat de klasse is HUACAYA INTERMEDIATE MALE WHITE getoond wordt
    En verwacht ik dat de klassecode 223 getoond wordt
