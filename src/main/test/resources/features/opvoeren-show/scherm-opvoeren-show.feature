...
Stel ik ben als administratiemedewerker op het scherm 'show gegevens' # waar kom ik vandaan? > story, # autorisatie? > story
...
Dan verwacht ik een melding 'showgegevens opgeslagen'
# en dan? 
...
Dan verwacht ik dat ik terug ga naar het scherm 'show gegevens'
